...
import { DEFAULT_ADS, fetchAds } from "@/lib/ads";
export default function CampusAd({ placement = "landing" }: { placement?: "landing" | "placeCard" }) {
  ...
  const ad = ads[placement]; if (!ad?.enabled) return null;
