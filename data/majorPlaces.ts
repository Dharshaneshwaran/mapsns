...
export const conferenceEvents: ConferenceEvent[] = [
  ...
  { title: "Inauguration", venue: "Open Auditorium", names: ["open auditorium", "sns open auditorium", "sns open autorium", "main hall"], locationId: "a4b04246-3348-4ce1-b521-d6b4f3e5490b", image: "/uploads/map-images/15ee30aefd4e93c3cae803c6a2bd8edbdc8c7f0a51b84d54ee0e72c51a776a2e.png" },
  { title: "Panel 1 + 2 + 3", venue: "DT Playhouse", names: ["dtplayhouse", "dt playhouse", "parallel panel sessions"], locationId: "79999ce7-d83c-4eeb-b811-c61d0d7fb451", image: "/uploads/map-images/8f5b50c8ed91c1db2ee532d54a541a6362b505d2eafabcf611e25d3a064ef5ca.png" },
  { title: "Panel 4", venue: "RM Hall, AI Campus, 1st Floor", names: ["rm hall"], locationId: "da12d649-0844-4d5b-ba79-7382aa3d9b09", image: "/RM%20hall.jpeg" },
